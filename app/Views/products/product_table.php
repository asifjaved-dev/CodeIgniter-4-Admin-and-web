    ...
    <nav class="navbar navbar-main navbar-expand-lg bg-transparent shadow-none position-absolute px-4 w-100 z-index-2">
        <div class="container-fluid py-1">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="text-white font-weight-bolder ms-2">Product Table</h6>
            </nav>
        ...
        <div class="card card-body blur shadow-blur mx-4 mt-n6">
            <div class="row gx-4">
                <div class="col-auto my-auto">
                    ...
                    <a href="/soft/products/add" class="btn btn-primary btn-sm">Add Product</a>
                </div>
                <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
                    <div class="nav-wrapper position-relative end-0">
                        <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link mb-0 px-0 py-1" href="/soft/blog" role="tab"
                                    ...
                                    <table class="table table-flush dataTable-table" id="datatable-basic">
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th class="text-uppercase text-secondary text-sm font-weight-bolder opacity-7 ps-2">Product Title</th>
                                                ...
                                                <th class="text-center text-uppercase text-secondary text-sm font-weight-bolder opacity-7">Image</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <img src="public/uploads/products/<?= $row['product_image']; ?>" class="rounded" style="width:50px;height:50px" alt="">
                                                </td>
                                                <td class="text-md font-weight-normal text-end">
                                                    <?php if ($row['product_status']== 0) { ?>
                                                        <a class="btn btn-info btn-sm mx-auto" href="<?php echo base_url('soft/product_table/published/'.$row["product_id"]);?>">Active</a>
                                                    <?php } else {
                                                        ?>
                                                        <a class="btn btn-warning btn-sm mx-auto" href="<?php echo base_url('soft/product_table/unpublished/'.$row["product_id"]);?>">Deactive</a>
                                                        <?php }
                                                    ?>
                                                    <a href="<?php echo base_url('soft/product_edit/'.$row["product_id"]);?>" class="btn btn-success btn-sm mx-auto">Edit</a>
                                                    <a href="#" onclick="delete_product(<?php echo $row['product_id']?>);" class="btn btn-danger btn-sm mx-auto">Delete</a>
                                                </td>                                                
                                            </tr>
                                            <?php endforeach; ?>
                                            <?php else: ?>
...
function delete_product(id)
{
    ...
    {
        window.location.href='<?php echo base_url('/soft/product_table/delete/'); ?>/'+id;
    }
    return false;
}
</script>