      ...
      <div class="row gx-4">
        <div class="col-auto">
          <div class="avatar avatar-xl position-relative">
            <img src="public\assets\img\team-2.jpg" alt="profile-pic" class="w-100 border-radius-lg shadow-sm">
            <a href="javascript:;"
              class="btn btn-sm btn-icon-only bg-gradient-light position-absolute bottom-0 end-0 mb-n2 me-n2">
              <i class="fa fa-pen top-0"></i>
              <!-- <input type="file" name="userfile" class="fa fa-pen top-0 form-control-file"> -->
            </a>
          </div>
        </div>
    ...
    <div class="row">
      <div class="col-md-8 d-flex align-items-center">
        <div class="card-body">
          ...
          <?php endif; ?>
          <form role="form text-left" action="/soft/profile_info" method="POST">
            <div class="mb-3">
            ...
            <div class="mb-3">
              <textarea type="text" class="form-control" placeholder="Personal Information" name="personal_information"
                value=""><?= set_value('personal_information', $user['personal_information']) ?></textarea>
            </div>
            <div class="mb-3">
