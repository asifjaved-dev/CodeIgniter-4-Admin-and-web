...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3"
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link  active" href="/soft/contact_us">
          <div
            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
          ...
          <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Contact us</li>
        </ol>
                  ...
                  <tr>
                    ...
                    <td class="align-middle text-center">
                      <span class="text-secondary text-xs font-weight-bold">
                        <?= date('M d Y',strtotime($newsItem['created_on'])) ?>
                      </span>
                    </td>
                    <td class="text-md font-weight-normal text-end">
                        <a href="#" onclick="delete_data(<?php echo $newsItem['id']?>);" class="btn btn-danger btn-sm mx-auto">Delete</a>
                    </td>
                  </tr>
                  <?php endforeach; ?>
                  <?php else: ?>
...
function delete_data(id)
{
    ...
    {
        window.location.href='<?php echo base_url('/soft/contact_us/delete/'); ?>/'+id;
    }
    return false;
}
</script>