<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3"
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link  active" href="/soft/profile">
          <div
            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="row gx-4">
        <div class="col-auto">
          <div class="avatar avatar-xl position-relative">
            <img src="public\assets\img\team-2.jpg" alt="..." class="w-100 border-radius-lg shadow-sm">
    ...
    <div class="row">
      ...
      <div class="col-12 col-xl-4">
        <div class="card h-100">
          ...
          <div class="card-body p-3">
            <p class="text-sm">
              <?php echo $user['personal_information']; ?>
            </p>
            ...
            <ul class="list-group">
              ...
              <li class="list-group-item border-0 ps-0 pb-0">
                ...
                <a class="btn btn-facebook btn-simple mb-0 ps-1 pe-2 py-0" href="<?php echo $user['facebook']; ?>">
                  <i class="fab fa-facebook fa-lg"></i>
                </a>
                <a class="btn btn-twitter btn-simple mb-0 ps-1 pe-2 py-0" href="<?php echo $user['twitter']; ?>">
                  <i class="fab fa-twitter fa-lg"></i>
                </a>
                <a class="btn btn-instagram btn-simple mb-0 ps-1 pe-2 py-0" href="<?php echo $user['instagram']; ?>">
            ...
            <div class="row">
                ...
                <div class="card card-blog card-plain">
                  <div class="position-relative">
                    <a class="d-block shadow-xl border-radius-xl">
                      <img src=" public/assets/img/home-decor-1.jpg" alt="img-blur-shadow"
              ...
              <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
                <div class="card card-blog card-plain">
                  <div class="position-relative">
                    <a class="d-block shadow-xl border-radius-xl">
                      <img src=" public/assets/img/home-decor-2.jpg" alt="img-blur-shadow"
              ...
              <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
                <div class="card card-blog card-plain">
                  <div class="position-relative">
                    <a class="d-block shadow-xl border-radius-xl">
                      <img src=" public/assets/img/home-decor-3.jpg" alt="img-blur-shadow"
                        class="img-fluid shadow border-radius-xl">
                    </a>
                  </div>
                  <div class="card-body px-1 pb-0">
