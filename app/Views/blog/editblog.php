...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3"
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link  active" href="/soft/blogtable">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/soft/product_table">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 40 44" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <nav class="navbar navbar-main navbar-expand-lg bg-transparent shadow-none position-absolute px-4 w-100 z-index-2">
        <div class="container-fluid py-1">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="text-white font-weight-bolder ms-2">Blog Edit</h6>
            </nav>
            ...
            <div class="row gx-4">
                <div class="col-auto my-auto">
                    <div class="h-100">
                        ...
                        <a href="/soft/blogtable" class="btn btn-primary btn-sm">Back</a>
                    </div>
                </div>
    ...
    <div class="row">
      <div class="col-md-8 d-flex align-items-center">
        <div class="card-body">
          ...
          <?php endif; ?>
          <form role="form text-left" enctype="multipart/form-data" action="<?php echo base_url('/soft/editblog/'.$post['id']) ?>" method="POST">
          <div class="form-group mb-3">
              <label for="title" class="form-label">Post Title</label>
              <input type="text" name="title" class="form-control <?php echo (isset($validation) && $validation->hasError('title')) ? 'is-invalid' : ''; ?>" value="<?php echo set_value('title',$post['title']); ?>" id="title">
              <?php
            ...
            <div class="form-group mb-3">
              ...
              <input type="file" name="image" class="form-control" id="image" value="<?php echo set_value('image',$post['image']); ?>">
            </div>
            <div class="form-group mb-3">
              <label for="title" class="form-label">Post Body</label>
              <textarea name="body" id="body" class="form-control <?php echo (isset($validation) && $validation->hasError('body')) ? 'is-invalid' : ''; ?>"><?php echo set_value('body',$post['body']); ?></textarea>
              <?php
              if (isset($validation) && $validation->hasError('body')){
                echo '<p class="invalid-feedback">' .$validation->getError('body') .'</p>';
              }
              ?>
            </div>
      ...
      <div class="col-md-4 align-items-center mt-6">
              <img src="<?=('../public/uploads/'.$post['image']) ?>" class="w-100 px-3" alt="Blog-image">
              <p class="text-center mt-3">Post Image</p>
      </div>
    </div>
