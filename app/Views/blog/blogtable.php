    ...
    <nav class="navbar navbar-main navbar-expand-lg bg-transparent shadow-none position-absolute px-4 w-100 z-index-2">
        <div class="container-fluid py-1">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="text-white font-weight-bolder ms-2">Blog Table</h6>
            </nav>
        ...
        <div class="card card-body blur shadow-blur mx-4 mt-n6">
            <div class="row gx-4">
                <div class="col-auto my-auto">
                    ...
                    <a href="/soft/blog/create" class="btn btn-primary btn-sm">Create blog</a>
                </div>
                                    ...
                                    <table class="table table-flush dataTable-table" id="datatable-basic">
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th class="text-uppercase text-secondary text-sm font-weight-bolder opacity-7 ps-2">Slug</th>
                                                <th class="text-uppercase text-secondary text-sm font-weight-bolder opacity-7">Posted Date</th>
                                                <th class="text-center text-uppercase text-secondary text-sm font-weight-bolder opacity-7">Post Image</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <img src="public/uploads/blog/<?= $row['image']; ?>" class="rounded" style="width:50px;height:50px" alt="">
                                                </td>
                                                <td class="text-md font-weight-normal text-end">
                                                    <?php if ($row['status']== 0) { ?>
                                                        <a class="btn btn-info btn-sm mx-auto" href="<?php echo base_url('soft/blogtable/published/'.$row["id"]);?>">Active</a>
                                                    <?php } else {
                                                        ?>
                                                        <a class="btn btn-warning btn-sm mx-auto" href="<?php echo base_url('soft/blogtable/unpublished/'.$row["id"]);?>">Deactive</a>
                                                        <?php }
                                                    ?>
                                                    <a href="<?php echo base_url('soft/editblog/'.$row["id"]);?>" class="btn btn-success btn-sm mx-auto">Edit</a>
                                                    <a href="#" onclick="delete_data(<?php echo $row['id']?>);" class="btn btn-danger btn-sm mx-auto">Delete</a>
                                                </td>                                                
                                            </tr>
                                            <?php endforeach; ?>
                                            <?php else: ?>
                                            <tr>
                                                <td colspan="5"  class="text-md text-center font-weight-normal">No Data have been found!</td>
                                            </tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
...
function delete_data(id)
{
    ...
    {
        window.location.href='<?php echo base_url('/soft/blogtable/delete/'); ?>/'+id;
    }
    return false;
}
</script>