...
<body class="g-sidenav-show   bg-white">
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3"
    ...
    <div class="sidenav-footer mx-3 mt-3 pt-3">
      <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
        <div class="full-background" style="background-image: url(' ../public/assets/img/curved-images/white-curved.jpeg')">
        </div>
    ...
    <div class="container-fluid py-1">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 ps-2 me-sm-6 me-5">
          <li class="breadcrumb-item text-sm"><a class="text-white opacity-5 text-decoration-none" href="/soft/dashboard">Dashboard</a></li>
          <li class="breadcrumb-item text-sm text-white active" aria-current="page"><a class="text-white opacity-9 text-decoration-none" href="/soft/blogtable">Blog Table</a></li>
        </ol>
        <h6 class="text-white font-weight-bolder ms-2">Create Blog</h6>
      </nav>
  ...
  <div class="container py-4">
    <div class="row">
      <div class="col-md-8 d-flex align-items-center">
        <div class="card-body">
          <form role="form text-left" enctype="multipart/form-data" action="<?= base_url('soft/blog/store') ?>" method="POST">
            <div class="form-group mb-3">
              <label for="title" class="form-label">Post Title</label>
              <input type="text" name="title" class="form-control <?php echo (isset($validation) && $validation->hasError('title')) ? 'is-invalid' : ''; ?>" value="<?php echo set_value('title'); ?>" id="title">
              <?php
            ...
            <div class="form-group mb-3">
              ...
              <textarea name="body" id="body" class="form-control <?php echo (isset($validation) && $validation->hasError('body')) ? 'is-invalid' : ''; ?>"><?php echo set_value('body'); ?></textarea>
              <?php
            ...
            <div class="text-center">
              <button type="submit" name="submit" class="btn bg-gradient-dark w-100 my-4 mb-2">Create</button>
            </div>
          </form>
        </div>
      </div>
  ...
  <script src=" ../public/assets/js/plugins/Chart.extension.js"></script>
  <script>
    ...
    <script src=" ../public/assets/js/soft-ui-dashboard.min.js?v=1.0.2"></script>
</body>
